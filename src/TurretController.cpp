...
namespace ThornBots {
    TurretController::TurretController(pico::Drivers* m_driver) {
    ...
    float TurretController::getYawEncoderAngle() {
        return pico::motor::DjiMotor::encoderToDegrees(motor_yaw.getEncoderWrapped());
    }
    ...
    */
    ...
    int TurretController::getPitchMotorSpeed(bool useWASD, double right_stick_vert, double target_angle) {
        float position = pico::motor::DjiMotor::encoderToDegrees(motor_pitch.getEncoderWrapped());
